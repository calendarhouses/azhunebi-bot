...
function resolveCabinNumber(bindingCabinNumber, cabinFromNote) {
  if (
    bindingCabinNumber != null &&
    isValidCabinNumber(Number(bindingCabinNumber))
  ) {
    return Number(bindingCabinNumber);
  }

  if (cabinFromNote != null && isValidCabinNumber(Number(cabinFromNote))) {
    return Number(cabinFromNote);
  }
